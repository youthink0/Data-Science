...
def attack(adj: sp.csr_matrix, features: sp.csr_matrix, labels: ndarray,
    ...
    #self, features, adj, labels, target_node, n_perturbations, direct=True, n_influencers= 0, ll_cutoff=0.004, verbose=True, **kwargs
    model.attack(features, adj, labels, target_node, n_perturbations=n_perturbations, **kwargs)
